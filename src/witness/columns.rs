...
impl WitnessColumns {
    ...
    pub fn interpolate_wire_a(&self, domain: &PlonkDomain) -> Result<DensePolynomial<Fr>> {
    ...
    pub fn interpolate_wire_b(&self, domain: &PlonkDomain) -> Result<DensePolynomial<Fr>> {
    ...
    pub fn interpolate_wire_c(&self, domain: &PlonkDomain) -> Result<DensePolynomial<Fr>> {
